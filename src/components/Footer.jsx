...
export default function Footer() {
    return (
        <>
           <div className="w-full bg-warning p-4 mt-10">
                <div className="flex items-center justify-center">
                    ...
                    <p className="mx-2">Rizki Susilo Ramadhan</p>
                    <div>
                        |
                    </div>
                    <a className="flex mx-2" href = "https://www.linkedin.com/in/rizkisr/" target={'_blank'}>
                        <ExternalLinkIcon className="h-6 w-6"></ExternalLinkIcon>
                        Linkedin
                    </a> 
                </div> 
           </div>
